...
class tclacClimate : public climate::Climate, public esphome::uart::UARTDevice, public PollingComponent {
	...
	private:
		...
		optional<ClimatePreset> switch_preset;
		optional<ClimateFanMode> switch_fan_mode;
		optional<ClimateSwingMode> switch_swing_mode;
		optional<float> target_temperature_set;
		optional<ClimateMode> switch_climate_mode;

        bool additional_attr_changed = false;
	...
	public:
        ...
        ClimatePreset get_tx_switch_preset();
        ClimateFanMode get_tx_switch_fan_mode();
        ClimateSwingMode get_tx_switch_swing_mode();
        int get_tx_target_temperature_set();
        ClimateMode get_tx_switch_climate_mode();
